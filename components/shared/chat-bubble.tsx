    ...
    return (
        <div className="flex gap-2 p-3 flex-shrink-0">
            <input
                ...
                className="flex-1 px-3 py-2 border border-gray-200/50 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-150"
            />
            <button
                onClick={onSend}
